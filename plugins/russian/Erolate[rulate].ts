  ...
  'filters': {
    ...
    'cat': {
      ...
      'options': [
        ...
        { 'label': 'Авторские', 'value': '12' },
        { 'label': 'Игры 18+', 'value': '3' },
        { 'label': 'Манга для взрослых', 'value': '30' },
        { 'label': 'Машинный перевод', 'value': '38' },
        { 'label': 'Переводы', 'value': '15' },
        { 'label': 'Фанфики', 'value': '16' },
        { 'label': 'Эротические рассказы', 'value': '2' },
      ],
      'type': FilterTypes.Picker,
    },
    's_lang': {
    ...
    'fandoms': {
      ...
      'options': [
        ...
        { 'label': 'Аладдин / Aladdin', 'value': '86' },
        {
          'label': 'Алиса в Стране чудес / Alice in Wonderland',
          'value': '90',
        },
        { 'label': 'Американский папаша / American Dad', 'value': '85' },
        {
          'label': 'Атака титанов / Атака на титанов / Attack on Titan',
          'value': '41',
        },
        { 'label': 'Блич / Bleach', 'value': '58' },
        { 'label': 'Боевой континент', 'value': '101' },
        { 'label': 'Большой куш / One Piece', 'value': '18' },
        {
          'label':
            'Боруто: Новое поколение Наруто / Boruto: Naruto Next Generations',
          'value': '9',
        },
        { 'label': 'Бэтмен / The Batman', 'value': '36' },
        { 'label': 'Ведьмак / The Witcher', 'value': '53' },
        { 'label': 'Военная хроника маленькой девочки', 'value': '100' },
        { 'label': 'Волейбол / Haikyu!!', 'value': '37' },
        { 'label': 'Вселенная Марвел / Marvel Universe', 'value': '7' },
        {
          'label': 'Вселенная Марвел / Marvel Universe / Marvel Comics',
          'value': '52',
        },
        { 'label': 'Вселенная Стивена', 'value': '61' },
        { 'label': 'Вселенная DC / DC Universe / DC Comics', 'value': '48' },
        { 'label': 'Гарри Поттер / Harry Potter', 'value': '4' },
        { 'label': 'Гоэтия / Гоетия / Yοητεία / Ars Goetia', 'value': '77' },
        { 'label': 'Демоны старшей школы / High School DxD', 'value': '10' },
        { 'label': 'День сурка / Groundhog Day', 'value': '3' },
        { 'label': "Джессика Джонс / Marvel's Jessica Jones", 'value': '42' },
        { 'label': 'Дисней / The Walt Disney Company', 'value': '74' },
        { 'label': 'Древние свитки: Скайрим / TES: Skyrim', 'value': '15' },
        { 'label': 'Дэдпул / Deadpool', 'value': '22' },
        { 'label': 'Дэнни-призрак / Danny Phantom', 'value': '51' },
        { 'label': 'Железный человек / Iron Man', 'value': '19' },
        {
          'label':
            'Звёздная принцесса и силы зла / Стар против сил зла / Star vs. The Forces of Evil',
          'value': '50',
        },
        { 'label': 'Звездные Войны / Star Wars', 'value': '43' },
        { 'label': 'Звёздные Войны / Star Wars', 'value': '16' },
        { 'label': 'Игра престолов', 'value': '78' },
        { 'label': 'Касльвания / Castlevania', 'value': '29' },
        { 'label': 'Киберпанк 2077 / Cyberpunk 2077', 'value': '6' },
        { 'label': 'Код Гиас / Code Geass', 'value': '84' },
        { 'label': 'Кольцо Элдена', 'value': '60' },
        { 'label': 'Королевства Сердец / Kingdom Hearts', 'value': '93' },
        {
          'label': 'Красавица и чудовище / Beauty and the Beast',
          'value': '91',
        },
        { 'label': 'Красный, Белый, Черный, Желтый / RWBY', 'value': '32' },
        { 'label': 'Кунг фу панда', 'value': '81' },
        { 'label': 'Лига Легенд / League of Legends', 'value': '5' },
        { 'label': 'Люди Икс / X-Men', 'value': '25' },
        { 'label': 'Ма', 'value': '104' },
        { 'label': 'Маг на полную ставку / Quanzhi Fashi', 'value': '30' },
        {
          'label': 'Мастера меча онлайн / Sword Art Online / SAO',
          'value': '47',
        },
        { 'label': 'Мир Тьмы / World of Darkness', 'value': '28' },
        { 'label': 'Мой маленький пони / My Little Pony', 'value': '72' },
        {
          'label':
        ...
        { 'label': 'Мстители / The Avengers', 'value': '20' },
        {
          'label': 'Мстители. Эра Альтрона / The Avengers. Age of Ultron',
          'value': '24',
        },
        { 'label': 'Мулан / Mulan', 'value': '94' },
        { 'label': 'Наруто / Naruto', 'value': '2' },
        { 'label': 'Овервотч', 'value': '79' },
        { 'label': 'Поднятие уровня в одиночку', 'value': '87' },
        { 'label': 'Порновселенная / Porn Universe', 'value': '31' },
        { 'label': 'Прототип / Prototype', 'value': '44' },
        { 'label': 'Рапунцель: Запутанная история / Tangled', 'value': '96' },
        {
          'label':
            'Розовая пора моей школьной жизни сплошной обман / Yahari Ore no Seishun Love Come wa Machigatteiru',
          'value': '14',
        },
        { 'label': 'Русалочка / The Little Mermaid', 'value': '97' },
        { 'label': 'Сага о Винланде', 'value': '66' },
        { 'label': 'Светлячок / Firefly', 'value': '76' },
        {
          'label':
            'Сильнейший в истории ученик Кэнити / Shijou Saikyou no Deshi Kenichi',
          'value': '13',
        },
        { 'label': 'Симпсоны / The Simpsons', 'value': '73' },
        {
          'label': 'Судьба: Великий Приказ / Fate: Grand Order',
          'value': '54',
        },
        { 'label': 'Супергёрл(телесериал, 2015) / Supergirl', 'value': '95' },
        { 'label': 'Супермен / Superman', 'value': '1' },
        {
          'label': 'Теория большого взрыва / The Big Bang Theory',
          'value': '75',
        },
        { 'label': 'Тор / Thor', 'value': '27' },
        {
          'label':
            "У Коми-сан проблемы с общением / 古見さんは、コミュ症です / Komi Can't Communicate",
          'value': '11',
        },
        { 'label': 'Убийца Акаме / Akame ga Kill', 'value': '40' },
        { 'label': 'Уэнздей / Wednesday', 'value': '26' },
        { 'label': 'Фантастическая четвёрка / Fantastic Four', 'value': '21' },
        { 'label': 'Флэш / The Flash', 'value': '17' },
        { 'label': 'Хвост Феи / Fairy Tail', 'value': '59' },
        { 'label': 'Холодное сердце / Frozen', 'value': '92' },
        {
          'label': 'Человек одного удара / Ванпанчмен / One Punch-Man',
          'value': '39',
        },
        { 'label': 'Человек-паук / Spider-Man', 'value': '23' },
        { 'label': 'Чёрный зверь / Чёрный Пёс / Kuroinu', 'value': '35' },
        {
          'label':
            'Чёрный зверь: Развращение Благородных Воительниц / Black Beast: Corruption of the Noble Warriors',
          'value': '34',
        },
        { 'label': 'Школа мертвецов', 'value': '67' },
        { 'label': 'Школа строгого режима / Prison School', 'value': '12' },
        { 'label': 'Эффект Массы / Mass Effect', 'value': '57' },
        { 'label': 'Юные Титаны / Teen Titans', 'value': '49' },
        { 'label': 'Ars Goetia | Gods and Demons', 'value': '69' },
        { 'label': 'Biohazard', 'value': '99' },
        { 'label': 'CD', 'value': '103' },
        { 'label': 'CL', 'value': '70' },
        {
          'label': 'Daraku Reijou Hakoiri Ojou-sama Netorare Choukyou Kiroku',
          'value': '55',
        },
        { 'label': 'Doom', 'value': '64' },
        { 'label': 'Granblue fantasy', 'value': '88' },
        { 'label': 'Halo', 'value': '80' },
        { 'label': 'Highschool of the Dead/Школа мертвецов', 'value': '68' },
        { 'label': 'JK Bitch ni Shiboraretai', 'value': '56' },
        { 'label': 'Monogatari Series', 'value': '65' },
        { 'label': 'Monster girl quest', 'value': '62' },
        { 'label': 'Over', 'value': '102' },
        { 'label': 'Rapunzel/Рапунцель', 'value': '83' },
        { 'label': 'Resident Evil', 'value': '98' },
        { 'label': 'Solo leveling', 'value': '63' },
        { 'label': 'Tentacle Locker', 'value': '89' },
        { 'label': 'X-COM', 'value': '82' },
      ],
      'type': FilterTypes.CheckboxGroup,
    },
  },
