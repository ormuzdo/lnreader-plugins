...
const plugin = new ReadNovelFullPlugin({
  ...
  'filters': {
    'type': {
      ...
      'options': [
        { 'label': 'Hot Novel', 'value': 'sort/nov-love-hot' },
        { 'label': 'Completed Novel', 'value': 'sort/nov-love-complete' },
        { 'label': 'Most Popular', 'value': 'sort/nov-love-popular' },
      ],
    },
    'genres': {
      'type': 'Picker',
      ...
      'value': '',
      'options': [
        { 'label': 'Action', 'value': 'nov-love-genres/action' },
        { 'label': 'Adventure', 'value': 'nov-love-genres/adventure' },
        {
          'label': 'Anime & comics',
          'value': 'nov-love-genres/anime-&-comics',
        },
        { 'label': 'Comedy', 'value': 'nov-love-genres/comedy' },
        { 'label': 'Drama', 'value': 'nov-love-genres/drama' },
        { 'label': 'Eastern', 'value': 'nov-love-genres/eastern' },
        { 'label': 'Fan-fiction', 'value': 'nov-love-genres/fan-fiction' },
        { 'label': 'Fanfiction', 'value': 'nov-love-genres/fanfiction' },
        { 'label': 'Fantasy', 'value': 'nov-love-genres/fantasy' },
        { 'label': 'Game', 'value': 'nov-love-genres/game' },
        { 'label': 'Games', 'value': 'nov-love-genres/games' },
        { 'label': 'Gender bender', 'value': 'nov-love-genres/gender-bender' },
        { 'label': 'General', 'value': 'nov-love-genres/general' },
        { 'label': 'Harem', 'value': 'nov-love-genres/harem' },
        { 'label': 'Historical', 'value': 'nov-love-genres/historical' },
        { 'label': 'Horror', 'value': 'nov-love-genres/horror' },
        { 'label': 'Isekai', 'value': 'nov-love-genres/isekai' },
        { 'label': 'Josei', 'value': 'nov-love-genres/josei' },
        { 'label': 'Litrpg', 'value': 'nov-love-genres/litrpg' },
        { 'label': 'Magic', 'value': 'nov-love-genres/magic' },
        {
          'label': 'Magical realism',
          'value': 'nov-love-genres/magical-realism',
        },
        { 'label': 'Martial arts', 'value': 'nov-love-genres/martial-arts' },
        { 'label': 'Mature', 'value': 'nov-love-genres/mature' },
        { 'label': 'Mecha', 'value': 'nov-love-genres/mecha' },
        { 'label': 'Modern life', 'value': 'nov-love-genres/modern-life' },
        { 'label': 'Myster', 'value': 'nov-love-genres/myster' },
        { 'label': 'Mystery', 'value': 'nov-love-genres/mystery' },
        { 'label': 'Other', 'value': 'nov-love-genres/other' },
        { 'label': 'Psychological', 'value': 'nov-love-genres/psychological' },
        { 'label': 'Reincarnation', 'value': 'nov-love-genres/reincarnation' },
        { 'label': 'Report story', 'value': 'nov-love-genres/report-story' },
        { 'label': 'Romance', 'value': 'nov-love-genres/romance' },
        { 'label': 'Romance.smut', 'value': 'nov-love-genres/romance.smut' },
        { 'label': 'School life', 'value': 'nov-love-genres/school-life' },
        { 'label': 'Sci-fi', 'value': 'nov-love-genres/sci-fi' },
        { 'label': 'Seinen', 'value': 'nov-love-genres/seinen' },
        { 'label': 'Shoujo', 'value': 'nov-love-genres/shoujo' },
        { 'label': 'Shoujo ai', 'value': 'nov-love-genres/shoujo-ai' },
        { 'label': 'Shounen', 'value': 'nov-love-genres/shounen' },
        { 'label': 'Shounen ai', 'value': 'nov-love-genres/shounen-ai' },
        { 'label': 'Slice of life', 'value': 'nov-love-genres/slice-of-life' },
        { 'label': 'Smut', 'value': 'nov-love-genres/smut' },
        { 'label': 'Sports', 'value': 'nov-love-genres/sports' },
        { 'label': 'Supernatural', 'value': 'nov-love-genres/supernatural' },
        { 'label': 'System', 'value': 'nov-love-genres/system' },
        { 'label': 'Thriller', 'value': 'nov-love-genres/thriller' },
        { 'label': 'Tragedy', 'value': 'nov-love-genres/tragedy' },
        { 'label': 'Urban', 'value': 'nov-love-genres/urban' },
        { 'label': 'Urban life', 'value': 'nov-love-genres/urban-life' },
        { 'label': 'Video games', 'value': 'nov-love-genres/video-games' },
        { 'label': 'War', 'value': 'nov-love-genres/war' },
        { 'label': 'Wuxia', 'value': 'nov-love-genres/wuxia' },
        { 'label': 'Xianxia', 'value': 'nov-love-genres/xianxia' },
        { 'label': 'Xuanhuan', 'value': 'nov-love-genres/xuanhuan' },
        { 'label': 'Yaoi', 'value': 'nov-love-genres/yaoi' },
        { 'label': 'Yuri', 'value': 'nov-love-genres/yuri' },
      ],
    },
  },
});
